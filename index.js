			...
			Steam.getUserOwnedGames(id, true)
				.then(ownedGames => {
					...
					if (appIDs.includes(2231450)) {
						...
						message.reply("It looks like you don't own Pizza Tower on Steam... If you do, please contact an admin.");
					}
				})
				.catch(() => {
					message.reply("I can't access your Steam games list. You probably made it private, check your profile settings!");
					return
				})
		})
		.catch(() => {
